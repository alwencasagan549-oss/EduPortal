...
<body style="overflow-x: hidden;">
    ...
    <!-- Navigation -->
    <nav
        style="display: flex; justify-content: space-between; align-items: center; padding: 2rem 5%; height: var(--header-height); position: relative; z-index: 100;">
        ...
        <div style="display: flex; gap: 2rem; align-items: center;">
            <a href="admin/login.php"
                style="color: var(--text-muted); text-decoration: none; font-weight: 500; transition: color 0.2s;"
                onmouseover="this.style.color='var(--text-main)'"
                onmouseout="this.style.color='var(--text-muted)'">Login as Admin</a>
            <a href="student/login.php" class="premium-btn premium-btn-primary" style="padding: 0.6rem 1.2rem;">Login as
                Student</a>
        </div>
    </nav>
    ...
    <section class="section-container" style="text-align: center; position: relative; padding-top: 4rem;">
        <div style="max-width: 1000px; margin: 0 auto;" class="animate-fade-up">
            ...
            <h1
                style="font-size: 4.5rem; font-weight: 800; line-height: 1.1; margin-bottom: 1.5rem; letter-spacing: -2px;">
                The Smarter Way to <span class="gradient-text">Manage Learning</span>
            </h1>
            <p
                style="font-size: 1.3rem; color: var(--text-muted); margin-bottom: 3rem; max-width: 750px; margin-inline: auto;">
            ...
            <div style="display: flex; gap: 1.5rem; justify-content: center; margin-top: 3rem; margin-bottom: 6rem;">
                <a href="teacher/signup.php" class="premium-btn premium-btn-outline"
                    style="padding: 1rem 2.5rem; font-size: 1.1rem; border-color: rgba(255,255,255,0.2);">
                    <i class="fas fa-chalkboard-user"></i> Sign up as Teacher
                </a>
                <a href="student/signup.php" class="premium-btn premium-btn-primary"
                    style="padding: 1rem 2.5rem; font-size: 1.1rem; border-radius: 16px;">
            ...
            <div class="glass-card-premium animate-float glow-border"
                ...
                <div
                    style="position: relative; border-radius: 16px; overflow: hidden; height: 580px; background: #000; box-shadow: inset 0 0 100px rgba(78, 115, 223, 0.1);">
    ...
    <section class="section-container" style="background: rgba(255,255,255,0.02); border-radius: 100px 0 100px 0;">
        <div style="text-align: center; margin-bottom: 5rem;">
            <h2 style="font-size: 3rem; font-weight: 800; margin-bottom: 1.5rem;">One Platform. <span
    ...
    <section class="section-container">
        <div style="text-align: center; margin-bottom: 5rem;">
            <h2 style="font-size: 3rem; font-weight: 800; margin-bottom: 1.5rem;">Simplified <span
    ...
    <section
        ...
        <div
            ...
            <div style="text-align: center;">
                <h3 style="font-size: 3.5rem; font-weight: 800; color: var(--primary-color); margin-bottom: 0.5rem;">
                    <?php echo number_format($total_submissions); ?>+
                </h3>
                <p
                    style="color: var(--text-muted); font-weight: 700; text-transform: uppercase; letter-spacing: 1px; font-size: 0.9rem;">
                    Global Submissions</p>
            </div>
            <div style="text-align: center;">
                <h3 style="font-size: 3.5rem; font-weight: 800; color: var(--success-color); margin-bottom: 0.5rem;">
            ...
            <div style="text-align: center;">
                <h3 style="font-size: 3.5rem; font-weight: 800; color: #a259ff; margin-bottom: 0.5rem;">
    ...
    <section class="section-container" style="text-align: center;">
        <div class="glass-card"
            style="padding: 6rem 3rem; background: linear-gradient(135deg, rgba(78, 115, 223, 0.1) 0%, rgba(162, 89, 255, 0.1) 100%);">
            <h2 style="font-size: 3.5rem; font-weight: 800; margin-bottom: 1.5rem; letter-spacing: -1.5px;">Ready to
                Start Your <span class="gradient-text">Modern Journey?</span></h2>
            <p
                style="color: var(--text-muted); font-size: 1.25rem; margin-bottom: 3rem; max-width: 650px; margin: 0 auto 3rem;">
                Join thousands of students and teachers already using EduPortal to redefine the digital classroom.</p>
            <div style="display: flex; gap: 1.5rem; justify-content: center;">
                <button onclick="document.getElementById('signupModal').style.display='flex'" class="premium-btn premium-btn-primary"
                    style="padding: 1.2rem 3.5rem; border-radius: 16px;">Create Account</button>
            </div>
        </div>
    </section>
    ...
    <div id="signupModal" class="loader-overlay" style="display: none; background: rgba(10, 11, 16, 0.9);">
        <div class="glass-card animate-scale-up" style="padding: 3rem; max-width: 500px; width: 90%; text-align: center; border: 1px solid var(--glass-border);">
            <div style="display: flex; justify-content: flex-end; margin-top: -1.5rem; margin-right: -1.5rem; margin-bottom: 1rem;">
                <button onclick="document.getElementById('signupModal').style.display='none'" style="background: none; border: none; color: var(--text-muted); font-size: 1.5rem; cursor: pointer;">&times;</button>
            </div>
            <h2 style="font-size: 2rem; font-weight: 800; margin-bottom: 1rem;">Get Started</h2>
            <p style="color: var(--text-muted); margin-bottom: 2.5rem;">Choose your account type to begin your journey with EduPortal.</p>
            
            <div style="display: flex; flex-direction: column; gap: 1.2rem;">
                <a href="teacher/signup.php" class="premium-btn premium-btn-outline" style="padding: 1.2rem; justify-content: center;">
                    <i class="fas fa-chalkboard-user"></i> Sign up as Teacher
                </a>
                <a href="student/signup.php" class="premium-btn premium-btn-primary" style="padding: 1.2rem; justify-content: center;">
    ...
    <footer style="padding: 3rem 5% 2rem; background: var(--bg-sidebar); border-top: 1px solid var(--glass-border);">
        <div style="max-width: 1200px; margin: 0 auto; display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 3rem;">
            <div>
                ...
                <p style="color: var(--text-muted); font-size: 0.9rem; line-height: 1.6;">Evolution of academic management with human-centric design.</p>
                <div style="display: flex; gap: 1.2rem; margin-top: 1.5rem;">
                    ...
                    <a href="#" style="color: var(--text-muted); font-size: 1.1rem;"><i class="fab fa-instagram"></i></a>
                </div>
            </div>
            <div>
                ...
                <ul style="list-style: none; display: flex; flex-direction: column; gap: 0.8rem;">
                    <li style="color: var(--text-muted); font-size: 0.9rem;"><i class="fab fa-html5" style="margin-right: 8px; color: #e34c26;"></i> HTML5 / CSS3</li>
                    <li style="color: var(--text-muted); font-size: 0.9rem;"><i class="fab fa-php" style="margin-right: 8px; color: #777bb4;"></i> PHP 8.1 Engine</li>
                    <li style="color: var(--text-muted); font-size: 0.9rem;"><i class="fas fa-database" style="margin-right: 8px; color: #00758f;"></i> MySQL Relational</li>
                    <li style="color: var(--text-muted); font-size: 0.9rem;"><i class="fab fa-js" style="margin-right: 8px; color: #f7df1e;"></i> Vanilla JS Streams</li>
                </ul>
            </div>
        </div>
        <div style="max-width: 1200px; margin: 3rem auto 0; padding-top: 1.5rem; border-top: 1px solid var(--glass-border); display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1.5rem;">
            <p style="color: var(--text-muted); font-size: 0.85rem;">&copy; <?php echo date('Y'); ?> EduPortal. Developed by <a href="https://casagan.vercel.app/" target="_blank" style="color: inherit; text-decoration: none; font-weight: 600; transition: color 0.2s;" onmouseover="this.style.color='#4e73df'" onmouseout="this.style.color='inherit'">Alwen T. Casagan</a>.</p>
            <div style="display: flex; gap: 2rem; color: var(--text-muted); font-size: 0.85rem;">
                ...
                <span>System Status: <span style="color: var(--success-color); font-weight: 600;">Operational</span></span>
            </div>
        </div>
    </footer>
