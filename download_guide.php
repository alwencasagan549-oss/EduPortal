...
<h2 style="border-bottom: none; margin-top: 0;">About EduPortal</h2>
<p>EduPortal is a modern, web-based <strong>Learning Management System (LMS)</strong> designed specifically for <strong>Ruben E. Ecleo Sr. National High School</strong>. It serves as a centralized digital platform that connects teachers and students, streamlining the assignment lifecycle from creation and distribution to submission and grading.</p>
<p>The system replaces traditional paper-based and fragmented communication methods with a unified, secure, and efficient online environment. Teachers can create and broadcast assignments to specific grade levels, sections, and strands, while students can submit their work digitally and receive instant feedback.</p>

<h3>Main Goal</h3>
<p>The primary goal of EduPortal is to <strong>digitize and simplify the academic workflow</strong> within the school. It aims to:</p>
<ul>
    <li>Eliminate paperwork and manual tracking of assignments and submissions.</li>
    <li>Enable teachers to reach the right students with targeted assignments based on grade, strand, and section.</li>
    <li>Provide students with a clear, organized view of their tasks, deadlines, and academic performance.</li>
    <li>Automate communication through built-in email notifications so no student misses an important update.</li>
    <li>Empower educators with real-time grading tools and insightful class analytics.</li>
</ul>

<h3>Vision</h3>
<p>To become the cornerstone of a <strong>fully digital, paperless, and future-ready educational experience</strong> at Ruben E. Ecleo Sr. National High School — where technology seamlessly supports teaching and learning, and every student and teacher thrives in a connected, efficient, and modern academic ecosystem.</p>

<h3>Mission</h3>
<p>To deliver a reliable, user-friendly, and secure learning management platform that bridges the gap between educators and learners. We are committed to:</p>
<ul>
    <li>Providing intuitive tools that simplify everyday academic tasks.</li>
    <li>Ensuring fair and transparent assignment delivery tailored to each class.</li>
    <li>Fostering better communication between teachers and students through instant notifications and direct messaging.</li>
    <li>Continuously improving the platform based on the real needs of our school community.</li>
</ul>
