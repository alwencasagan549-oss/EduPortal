    ...
    <main class="auth-card" id="main-content" style="max-width: 550px;">
        ...
        <form method="POST" data-loader="true">
            ...
            <div class="responsive-grid-stack" style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1.5rem;">
                <div>
                    <label for="lrn" style="display: block; margin-bottom: 0.5rem; color: var(--text-muted); font-size: 0.85rem;">LRN (12 Digits)</label>
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" autocomplete="name" required class="premium-input" placeholder="John Doe">
                </div>
            </div>
            
            <div class="responsive-grid-stack" style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1.5rem;">
                <div>
                    <label for="grade_level" style="display: block; margin-bottom: 0.5rem; color: var(--text-muted); font-size: 0.85rem;">Grade Level</label>
                    <select id="grade_level" name="grade_level" autocomplete="off" required class="premium-input">
                ...
                <div>
                    <label for="section" style="display: block; margin-bottom: 0.5rem; color: var(--text-muted); font-size: 0.85rem;">Section</label>
                    <input type="text" id="section" name="section" autocomplete="off" required class="premium-input" placeholder="e.g., HUMMS-A, STEM-B">
                </div>
                <div>
                    <label for="strand" style="display: block; margin-bottom: 0.5rem; color: var(--text-muted); font-size: 0.85rem;">Strand</label>
                    <select id="strand" name="strand" autocomplete="off" required class="premium-input">
            ...
            <div style="margin-bottom: 1.5rem;">
                <label for="email" style="display: block; margin-bottom: 0.5rem; color: var(--text-muted); font-size: 0.85rem;">Email Address</label>
                <input type="email" id="email" name="email" autocomplete="email" required class="premium-input" placeholder="john@example.com">
            </div>
